...
//@TODO if we ever get calendars inside packages then the ids will need to be replaced with classes contained within a distinct id
 	...
 	. $this->id . '&listid=' . $row->listid . '&rowid=' . $row->rowid . '&plugintask=' ;
			   ?>
				<tr>
					...
					<a class="fabrikTip" opts="{position:'right'}" title="<?php echo FStringHelper::truncate($row->content,
