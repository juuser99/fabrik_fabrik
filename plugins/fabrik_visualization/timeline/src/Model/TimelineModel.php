...
namespace Fabrik\Plugin\FabrikVisualization\Timeline\Model;
 ...
 * @since       4.0
 */
class TimelineModel extends AbstractVisualizationModel
{
	/**
	...
	protected function jsonEvents($listId, $total, $start, $c)
	{
		...
		if ($listModel->canView() || $listModel->canEdit())
		{
			...
			$endKey     = FStringHelper::safeColName($enddate2);
			$startKey   = FStringHelper::safeColName($startdate2);
