...
class Html extends JViewLegacy
{
	...
	public function display($tpl = 'default')
	{
		...
		$options->buttons->del  = '<button class="btn popupDelete" data-task="deleteCalEvent">' . HtmlHelper::icon('icon-delete') . '</button>';
		$options->buttons->edit = '<button class="btn popupEdit" data-task="editCalEvent">' . HtmlHelper::icon('icon-edit') . '</button>';
		$options->buttons->view = '<button class="btn popupView" data-task="viewCalEvent">' . HtmlHelper::icon('icon-eye') . '</button>';
		...
		$this->_setPath('template', JPATH_ROOT . '/plugins/fabrik_visualization/Calendar/Views/Calendar/tmpl/' . $tpl);
		HtmlHelper::stylesheetFromPath('plugins/fabrik_visualization/Calendar/Views/Calendar/tmpl/' . $tpl . '/template.css');

		// Adding custom.css, just for the heck of it
		HtmlHelper::stylesheetFromPath('plugins/fabrik_visualization/Calendar/Views/Calendar/tmpl/' . $tpl . '/custom.css');
	...
	public function chooseaddevent()
	{
		...
		HtmlHelper::addScriptDeclaration(implode("\n", $script));
	}
}
