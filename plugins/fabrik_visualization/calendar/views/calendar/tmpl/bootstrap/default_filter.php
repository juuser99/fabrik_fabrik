...
<?php
	foreach ($this->filters as $table => $filters) :
	  ...
	  <tr>
		...
		<th style="text-align:right"><a href="#" class="clearFilters"><i class="icon-refresh"></i> <?php echo Text::_('PLG_VISUALIZATION_CALENDAR_CLEAR'); ?></a></th>
	</tr>
	  <?php
			$c = 0;
	  ...
	  <button type="submit" class="btn btn-info">
	  	<i class="icon-filter"></i> <?php echo Text::_('PLG_VISUALIZATION_CALENDAR_GO') ?>
	  </button>
	  </th></tr></tfoot></table>
	  <?php
		endif;
