...
class HtmlView extends BaseView
{
	...
	public function display($tpl = null)
	{
		...
		$tmplpath     = JPATH_ROOT . '/plugins/fabrik_visualization/calendar/tmpl/' . $tpl;
		$this->_setPath('template', $tmplpath);
		Html::stylesheetFromPath('plugins/fabrik_visualization/calendar/tmpl/' . $tpl . '/template.css');

		// Adding custom.css, just for the heck of it
		Html::stylesheetFromPath('plugins/fabrik_visualization/calendar/tmpl/' . $tpl . '/custom.css');
