    ...
    constructor: function (id, options) {
        ...
        this.col.each(function (tr) {
            var stars = tr.getElements('.starRating'),
                ratingMsg = star.closest('.fabrik_element').find('.ratingMessage');

            stars.each(function (star) {
                star.on('mouseover', function () {
                    self.origRating[tr.id] = parseInt(ratingMsg.html(), 10);
                    ...
                    ratingMsg.html(star.data('fabrik-rating'));
                });
                ...
                star.on('mouseout', function () {
                    ...
                    star.closest('.fabrik_element').find('.ratingMessage').html(self.origRating[tr.id]);
                });
            });
