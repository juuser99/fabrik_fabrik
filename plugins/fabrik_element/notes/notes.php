 ...
 * @since       3.0
 */
class PlgFabrik_ElementNotes extends AbstractElementDatabaseJoinPlugin
{
	/**
	...
	protected function getOrderBy($view = '', $query = false)
	{
		...
		{
			$order = FStringHelper::safeQuoteName($params->get('join_db_name') . '.' . $orderBy) . ' ' . $params->get('notes_order_dir', 'ASC');
