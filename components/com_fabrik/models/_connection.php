 ...
 * @since       3.5
 *
 * @deprecated - use Admin model instead.
 */
class Connection extends \JModelBase
{
	/**
	 * Current connection
	 *
	 ...
	 *
	 * @return mixed database object using connection details false if connection error
	 * @throws RuntimeException
	 */
