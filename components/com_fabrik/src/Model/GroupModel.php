...
class GroupModel extends FabrikSiteModel
{
	 ...
	 * Set the group row
	 *
	 * @param   GroupTable $group Fabrik table
	 *
	 * @since   4.0
	 *
	 * @return  void
	 */
	public function setGroup(GroupTable $group)
	{
		$this->group = $group;
	}
	...
	public function setColumnCss(&$element, $rowIx)
	{
		...
		if ($colCount === 1) // Single column
		{
			...
			$element->endRow   = 1;
			$element->span     = Html::getGridSpan('12');
	 ...
	 * @since 4.0
	 */
	public function getGroupProperties(FormModel $formModel)
	{
	...
	public function fkPublished()
	{
		...
		throw new \Exception(Text::sprintf('COM_FABRIK_JOINED_DATA_BUT_FK_NOT_PUBLISHED', $fullFk));
	}
