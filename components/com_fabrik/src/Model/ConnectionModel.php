...
class ConnectionModel extends FabSiteModel
{
	...
	{
		return (new DatabaseFactory)->getDriver($options);
	}
	 ...
	 *
	 * @return  ConnectionTable  Connection tables
	 *
	 * @since 4.0
	 */
	...
	{
		return StringHelper::rtrimword($driverName, Worker::j4() ? 'fab' : '_fab');
	}
	 ...
	 *
	 * @return  ConnectionTable  default connection
	 *
	 * @since 4.0
	 */
