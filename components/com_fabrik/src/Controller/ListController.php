 ...
 * @since       4.0
 */
class ListController extends AbstractSiteController
{
	/**
	...
	public function display($cachable = false, $urlparams = false)
	{
		...
		$extraQS = Worker::getMenuOrRequestVar('list_extra_query_string', '', false, 'menu');
		...
		/** @var ListModel $model */
		$model = (null === $this->listModel) ? $this->getModel(ListModel::class) : $this->listModel;
