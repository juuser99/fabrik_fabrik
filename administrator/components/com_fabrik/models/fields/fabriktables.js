	...
	setUp : function () {
		...
		if (this.cnn.hasClass('chzn-done')) {
			jQuery('#' + this.cnn.id).on('change', function (event) {
				document.id(self.cnn).trigger('change', new Event.Mock('change', document.id(self.cnn)));
			});
		}
		...
		if (this.el.hasClass('chzn-done')) {
			jQuery('#' + this.el.id).on('change', function (event) {
				document.id(self.el.id).trigger('change', new Event.Mock('change', document.id(self.el.id)));
			});
		}
