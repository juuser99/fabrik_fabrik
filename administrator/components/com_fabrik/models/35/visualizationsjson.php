...
require_once JPATH_ADMINISTRATOR . '/components/com_fabrik/models/visualizations.php';
...
class FabrikAdminModelVisualizationsJSON extends FabrikAdminModelVisualizations
{
	/**
	 * Constructor.
	 *
