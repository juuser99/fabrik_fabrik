...
class TextOrWYSIWYGField extends TextField
{
	 ...
	 * @since 4.0
	 */
	protected $type = 'textorwysiwyg';

	/**
	 * @var mixed Editor Object
	 *
	 * @since 4.0
	 */
	public $editor;
	...
	protected function getInput()
	{
		...
		if ($config->get('fbConf_wysiwyg_label', '0') == '0')
		{
			...
			$class     = ' class="form-control' . ($this->element['class'] ? ' '.(string) $this->element['class'] : '') . '"';
	...
	protected function getEditor()
	{
		...
		if (empty($this->editor))
		{
			...
			$this->editor = Editor::getInstance($editor ? $editor : null);
		}
