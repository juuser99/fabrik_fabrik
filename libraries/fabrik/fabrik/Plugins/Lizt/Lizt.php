...
class Lizt extends Plugin
{
	...
	public function onGetFilterKey()
	{
		...
		$this->filterKey = str_ireplace('fabrik\plugins\lizt\\', '', $this->filterKey);
	...
	{
		return 'com_' . $this->package . '.list' . $this->getModel()->getRenderContext() . '.plugins.' . $this->onGetFilterKey() . '.';
	}
